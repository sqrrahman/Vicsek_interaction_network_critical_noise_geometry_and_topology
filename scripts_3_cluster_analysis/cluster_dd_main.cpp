...
int main() {
    int N = 1 << 15; // number of agents
    int num_bins = 32;
    
    // Process all simulations (sim_01 to sim_30)
    for (int sim_num = 1; sim_num <= 30; ++sim_num) {
        // Process all time steps (0 to 2000000, every 10000)
        for (int time_step = 0; time_step <= 2000000; time_step += 10000) {
